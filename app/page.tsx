  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-gray-900 p-4 xs:p-4 sm:p-6 md:p-8" role="main" aria-label="Meal Planner System Home">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Developer Resources */}
        <section aria-labelledby="developer-resources" className="mb-12">
          <Card padding="lg">
            <h2 id="developer-resources" className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
              Developer Resources
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Link href="/api-docs" className="block p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-primary-500 dark:hover:border-primary-400 transition-colors">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Interactive Swagger/OpenAPI documentation with live testing
                </p>
              </Link>
              <Link href="/audit-logs" className="block p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-primary-500 dark:hover:border-primary-400 transition-colors">
                <div className="flex items-center gap-3 mb-2">
                  <svg className="w-5 h-5 text-primary-600 dark:text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  View system audit logs and security events (Admin only)
                </p>
              </Link>
            </div>
          </Card>
